...
public class Controller {
    ...
    @PutMapping("/api/createOrgUserSpacePermissions/{user}")
    public Map<String, String> createOrgUserSpacePermissions(@PathVariable String user) throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
        String myOrg = getUsersSandboxOrg(user);
